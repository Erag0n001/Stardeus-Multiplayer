...
//            }
//            public static bool Prefix(bool __result, AIGoal goal)
//            {
//                Printer.Warn($"{IsFromServer}");
//                if (IsFromServer)
//                    return true;
//                if (!Main.isHost)
//                {
//                    return false;
//                }
//                AIGoalManager.localGoals.Add(goal);
//                __result = false;
//                return true;
//            }
//            [HarmonyPostfix]
...
//            {
//                Printer.Warn($"Tried adding goal ({goal}) to {__instance}. FromServer: {IsFromServer}");
//                if (!__result)
//                    return;
//                if (IsFromServer)
//                {
